      ...
      <section className="relative w-full h-[90vh] min-h-[600px] flex items-end pb-24 md:pb-32 overflow-hidden">
        <div className="absolute inset-0 -z-10 bg-charcoal">
          <Image
            ...
            alt="You Feed Them mission team in the field"
            fill
            className="object-cover object-center saturate-[0.85] sepia-[0.05]"
            priority
            sizes="100vw"
          />
          <div className="absolute inset-0 bg-gradient-to-t from-forest/90 via-forest/55 to-forest/15" />
        </div>
          ...
          <BlurFade delay={0.2}>
            <div className="w-full h-[400px] lg:h-[500px] bg-charcoal relative overflow-hidden">
              <Image
                ...
                alt="Pastor Titus Mashalla and family, YFT&rsquo;s field partner in Tanzania"
                fill
      ...
      <section className="bg-forest py-24 md:py-28">
        <div className="container mx-auto px-8 max-w-7xl">
          ...
          <div className="flex flex-col gap-10 lg:gap-0">
            <BlurFade delay={0.1}>
              <div className="lg:grid lg:grid-cols-[1fr_2fr] lg:gap-16 items-baseline border-t border-cream/10 pt-10 pb-10">
            ...
            <BlurFade delay={0.4}>
              <div className="lg:grid lg:grid-cols-[1fr_2fr] lg:gap-16 items-baseline border-t border-cream/10 pt-10 pb-10 border-b">
                <span className="font-sans text-lg md:text-xl uppercase tracking-[0.12em] text-gold font-bold block mb-3 lg:mb-0">
                  Church &amp; Community
                </span>
                <p className="font-heading text-2xl md:text-3xl text-cream leading-[1.3]">
